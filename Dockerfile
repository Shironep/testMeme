...
CMD ["sh", "-c", "vncserver :2 -depth 24 -geometry 1024x768 && websockify -D --web=/usr/share/novnc/ --cert=/etc/ssl/certs/ssl-cert-snakeoil.pem --key=/etc/ssl/private/ssl-cert-snakeoil.key 6080 localhost:5901"]
